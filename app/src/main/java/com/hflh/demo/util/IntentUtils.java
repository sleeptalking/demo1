...
public class IntentUtils {
    ...
    public static void toActivity(final Activity activity, final Intent intent, final int requestCode, final boolean showAnimation) {
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (showAnimation) {
                    activity.overridePendingTransition(R.anim.right_push_in, R.anim.right_push_out);
                }
            }
        });
    }
    ...
    public static void toPicture(final Activity context, final int requestCode){
